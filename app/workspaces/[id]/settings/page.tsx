...
function PDFBrandingCard() {
 const KEYS = [
 { key: 'pdf_company', label: 'Company Name', placeholder: 'e.g. Enterprise Power' },
 { key: 'pdf_project', label: 'Project Name', placeholder: 'e.g. 33kV Substation' },
 { key: 'pdf_contract', label: 'Contract No.', placeholder: 'e.g. ' },
 { key: 'pdf_substation', label: 'Substation Name', placeholder: 'e.g. 33kV SS' },
