 ...
 * based on Engineering Standard formulas.
 * 
...
function manuallyCalculateResults(input) {
 ...
 console.log("STEP 8: Available Kssc (CORE FORMULA FROM ENGINEERING STANDARD)");
...
console.log("║" + " Based on Engineering Standard ".padStart(70) + "║");
console.log("╚" + "═".repeat(68) + "╝");
