 ...
 * Tests against exact values from Engineering Specification 
 */

import { Siemens7SJ85Calculator } from '../lib/services/siemens-7sj85-calculations';

// Exact input values from standard document
const STANDARD_TEST_DATA = {
 ct_wiring: {
...
// Expected results from standard document
...
/**
 * Run verification test against standard document values
 */
export function runVerificationTest(): { 
 ...
 console.log('📋 Testing against Engineering Specification ');
 console.log('=' .repeat(60));

 // Run the calculation
 const results = Siemens7SJ85Calculator.performCompleteCalculation(STANDARD_TEST_DATA);
...
const STANDARD_TEST_DATA_ALIAS = STANDARD_TEST_DATA;
// Export for use in other files
export { STANDARD_TEST_DATA, STANDARD_TEST_DATA_ALIAS, EXPECTED_RESULTS };