 ...
 * Reference: Hitachi N-19957 2-DF4W Standard
 */

console.log('╔' + '═'.repeat(80) + '╗');
console.log('║' + ' EXACT NUMERICAL OUTPUT VERIFICATION '.padStart(83) + '║');
console.log('║' + ' Does 2+2 = 4 or something else? '.padStart(83) + '║');
console.log('║' + ' Reference: Hitachi N-19957 2-DF4W '.padStart(83) + '║');
console.log('╚' + '═'.repeat(80) + '╝');

// ============================================================
// TEST CASE 1: EXACT VALUES FROM HITACHI DOCUMENT
// ============================================================

console.log('\n\n' + '═'.repeat(80));
console.log('TEST CASE 1: EXACT HITACHI DOCUMENT VALUES');
console.log('═'.repeat(80));
...
const inputs = {
  // CT Parameters (Page 1 of Hitachi document)
  ...
  // Wiring (Page 1 of Hitachi document)
  ...
  // System (Page 2 of Hitachi document)
...
console.log('\n\nSTEP 6: Calculate Available Kssc (CORE FORMULA FROM HITACHI)');
console.log('─'.repeat(80));
