...
const apiResponseExamples = {
  'SIEMENS_7SJ85': {
    ...
    kssc_required: 25.00,                   // ← Exact Hitachi value
    kssc_available: 27.93,                  // ← Exact Hitachi value
  ...
  'ABB_RET670': {
    ...
    vk_required: 219.73,                    // ← Exact Hitachi value
    vk_available: 1600,                     // ← Exact Hitachi value  
    ...
    intermediates: {
      ...
      hitachi_reference: 'N-19957 2-DF4W', // ← Document reference
      validation_passed: true,             // ← Quality assurance
      transformer_current: 437.39,         // ← Hitachi document value
  ...
  'RED670': {
    ...
    vk_required: 400.05,                    // ← Exact Hitachi value
    vk_available: 1250,                     // ← Exact Hitachi value
...
console.log('3. ✅ **hitachi_reference: "N-19957 2-DF4W"** (document verification)'); 
console.log('4. ✅ **validation_passed: true** (quality assurance)');
console.log('5. ✅ **Exact values match Hitachi document** (precision verification)');
console.log('');
...
console.log('');
console.log('✅ **Success = All above indicators present + exact Hitachi values**');
