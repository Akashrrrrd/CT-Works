...
async function seedSampleData() {
 ...
 const existingOrg = await organizationsCollection.findOne({ name: 'Enterprise Power' });
 
 let organizationId;
 if (!existingOrg) {
 const orgResult = await organizationsCollection.insertOne({
 name: 'Enterprise Power',
 domain: 'enterprisepower.com',
 logo: null,
 address: {
 ...
 const sampleUsers = [
 {
 email: 'john.smith@enterprisepower.com',
 name: 'John Smith',
 ...
 {
 email: 'sarah.johnson@enterprisepower.com',
 name: 'Sarah Johnson',
 ...
 {
 email: 'mike.chen@enterprisepower.com',
 name: 'Mike Chen',
 password: '$2a$10$example.hash.for.password123',
 role: 'MANAGER',
 organizationId,
 ...
 {
 email: 'emma.wilson@enterprisepower.com',
 name: 'Emma Wilson',
 password: '$2a$10$example.hash.for.password123',
 role: 'ENGINEER',
 organizationId,
 ...
 console.log('\n📊 Summary:');
 console.log(`- Organization: Enterprise Power`);
