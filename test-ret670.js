 ...
 * Based on Engineering Document pages 5-9
 */

console.log('🧪 Testing ABB RET670 Transformer Protection Calculations...');
console.log('📋 Using Engineering Document test values');
...
// From Standard Engineering document page 7: the calculations use different CT parameters
...
if (allPassed) {
 ...
 console.log('📋 All calculations validated against the standard document.');
