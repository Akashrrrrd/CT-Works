...
export function Siemens7SJ85Calculator() {
 ...
 // Default values from Standard Engineering document
 ct_wiring: {
...
<body>
 ...
 <p>Multi-function Protection Relay</p>
 ...
 <td class="value">132/33kV Substation</td>
 </tr>
 <tr>
 ...
 <CardDescription>
 Multi-function Protection Relay</CardDescription>
 </div>
 </div>
 <div className="flex gap-2 mt-4">
 <Badge variant="secondary">132/33kV Substation</Badge>
 <Badge variant="secondary">Standard Area</Badge>
 ...
 CT adequacy assessment based on standard engineering calculations
 </p>
 </div>
 </CardContent>
 </Card>
 ...
 <div><strong>Substation:</strong> 132/33kV Substation</div>
 <div><strong>Date:</strong> 4/22/2026</div>
 <div><strong>Contractor:</strong> STANDARD</div>
 </div>
 </CardContent>
 </Card>
 </div>
