        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>
                Multi-Function Transformer Protection Relay - Per Hitachi Standards N-19957 2-DF4W
              </CardDescription>
            </div>
          </div>
            ...
            <CardContent>
              <div className="text-center p-6 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-600 mt-2">
                  Transformer differential protection CT adequacy per Hitachi standards
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="text-sm text-gray-600">
                    <p className="font-medium">Expected Values (Hitachi Doc):</p>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p><strong>Contractor:</strong> HITACHI</p>
